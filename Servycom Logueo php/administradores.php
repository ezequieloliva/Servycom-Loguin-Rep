...
.auto-style2 {
	...
	<!-- Header -->
					...
					<!-- Menu -->
<form method= "post" action= insertarAdm.php> 
					...
					<nav id="menu">
						<div class="inner">
							...
							<ul >
							     ...
							     <input type="text" name="claveIn" id="claveIn">
					...
					<nav id="menu">
						<div class="inner">
							<h4>Modificar Datos de Administrador:</h4>
							<ul >
							     <label for="name">Nombre:</label>
							    ...
							    <?php 
		                                $cn=new mysqli("wo22","loguinse_eoliva","Clave123","loguinse_base_loguin");
 		                                $registros= $cn->query("select * from administrador");
							     ...
							     <label for="clave">Clave</label>
							     <input type="text" name="claveMod"id="claveMod">
	...
	<div id="cuadro">
		...
		<div id="titulo">
		<center><h1>Administradores autorizados</h1></center>
	</div>
